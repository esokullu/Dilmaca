...
class CYCLE3{
    ...
    public CYCLE3(int i) {
         ...
         */
        this.dealWithUnchangeablesAtTheBeginningOfTheSentence();
         ...
         */
        this.dealWithUnchangeablesInTheSentence();
         ...
         */
        this.dealWithNumericsAndPlurals(); // plurallar artik çekimli
        /*
        ...
        */
        this.clarifyVerbsAndNounsWRTPositionOfDefiners();
        /*
         ...
         * xxconjugatdverb_behind takýsý getiriyor.
         */
        this.connectVerbsSeparatedByCommas();
        /*
         * ConjugatedVerbleri azaltýyor, toparlýyor.
         * xxconjugated_verb takýsý ya ConjugatedVerb nesnesi içinde conjugate() metodunda
         * ya da en sonda temizlenmeli ..
         */
         ...
         * açýklýk getirmek
         */
        this.clarifyTheSituationOfThePronounThat();
        /*
         ...
         */
        this.mergeAdjectivesAndAdverbs();
        /*
         ...
         */
        this.dealWithAdverbsAndNONearVerbs();
        /*
         ...
         */
        this.attachAdjectivesAndNouns(); // bi de somebody very precious for me
        /*
         ...
         */
        this.putAdjectivePronouns(); // onlar kalmiyor, Noun ya da Article
        /*
         ...
         */
        this.connectNounsSeparatedByCommas();
        /*
        ...
        */
        ...
        /*
         * Eðer bi yüklemden önce query pronoun geliyorsa
         * e yüklemin de query özelliði varsa bunu yok ediyor.
         * Ayrýca by soru yükleminden sonra geliyorsa tarafýndan anlamýný kazanýyor.
         */
        this.queryPronounsBeforeConjugatedVerbs();
        /*
         * Türkçe ile Ýngilizce arasýndaki önemli bir fark halledilmiþ oluyor.
         * Query Pronoun lara silinip, ConjugatedVerb e adverb olarak eklenniyor.
         * Query özellikli ConjugatedVerbler bu özelliklerini kaybediyor.
         */
        
        
        /*
         * ^^ ile baþlayan DatabasePrivateWords leri temizliyor.
         */
        this.clearDatabasePrivateWords();
        /*
         * Cümlemizde artýk DatabasePrivateWord kalmýþ olamaz
         * Ýlerde bu metod PHRASE sýnýfýna eklenebilir.
         */
         ...
         */
        this.dealWithConjugatedVerbProperties();
        /*
         ...
         */
        this.finishPrepositionsAndAdjectivePatterns();
        /*
         * bulanýklar daha az
 ...
 ******************************************/
    ...
    * xxconjugatedverb_behind# takýsýný koyuyor !! bu conjugatedverb ayaðýnda
    * veya en son ayakta temizlenmeli
    * <br>
    ...
    */
    private void connectVerbsSeparatedByCommas() {
        ...
        ConjugatedVerb tempConjugatedVerb=new ConjugatedVerb();
        ...
        for ( int i = GlobalVars.OBJECT.size()-2 ; i >= 1 ; i-- ) {
            ...
            if ( GlobalVars.OBJECT.get(i) instanceof Comma && ( GlobalVars.OBJECT.get(i-1) instanceof ConjugatedVerb || GlobalVars.OBJECT.get(i+1) instanceof ConjugatedVerb ) ) {
                ...
                if ( GlobalVars.OBJECT.get(i-1) instanceof ConjugatedVerb && GlobalVars.OBJECT.get(i+1) instanceof ConjugatedVerb ) {
                    ...
                    System.out.println("ConjugatedVerb + Comma + ConjugatedVerb");
                    if ( GlobalVars.OBJECT.getComma(i).isComma() )
                        GlobalVars.OBJECT.getConjugatedVerb(i+1).setStack( GlobalVars.OBJECT.getConjugatedVerb(i-1).getStack()+" xxconjugatedverb_behind#, "+GlobalVars.OBJECT.getConjugatedVerb(i+1).getStack() ) ;
                    else
                        GlobalVars.OBJECT.getConjugatedVerb(i+1).setStack( GlobalVars.OBJECT.getConjugatedVerb(i-1).getStack()+" xxconjugatedverb_behind# "+GlobalVars.OBJECT.getComma(i).getStack()+' '+GlobalVars.OBJECT.getConjugatedVerb(i+1).getStack() ) ;
                    GlobalVars.OBJECT.remove(i);
                    GlobalVars.OBJECT.remove(i-1);
                    
                    // i ye deðiþiklik yapmýyoruz.
                    // çünkü eski i-1 gitti yerine eski i-2 geldi.

                }
                else if ( GlobalVars.OBJECT.get(i-1) instanceof Verb || GlobalVars.OBJECT.get(i-1) instanceof EndsD || ( GlobalVars.OBJECT.get(i-1) instanceof Noun && GlobalVars.OBJECT.getNoun(i-1).mayBeVerb() ) ) {

                     System.out.println("Verb + Comma + ConjugatedVerb");
                    if ( GlobalVars.OBJECT.getComma(i).isComma() )
                        GlobalVars.OBJECT.getConjugatedVerb(i+1).setStack( GlobalVars.OBJECT.getVerbalOBJECT(i-1).getVerb() +" xxconjugatedverb_behind#, "+GlobalVars.OBJECT.getConjugatedVerb(i+1).getStack() ) ;
                    else
                        GlobalVars.OBJECT.getConjugatedVerb(i+1).setStack( GlobalVars.OBJECT.getVerbalOBJECT(i-1).getVerb() +" xxconjugatedverb_behind# "+GlobalVars.OBJECT.getComma(i).getStack()+' '+GlobalVars.OBJECT.getConjugatedVerb(i+1).getStack() ) ;
 ...
 System.out.println("ConjugatedVerb + Comma + Verb");
                    
                    if ( GlobalVars.OBJECT.getComma(i).isComma() )
                        GlobalVars.OBJECT.getConjugatedVerb(i-1).setStack( GlobalVars.OBJECT.getConjugatedVerb(i-1).getStack() + " xxconjugatedverb_behind#, " + GlobalVars.OBJECT.getConjugatableVerbalOBJECT(i+1).getVerb() ) ;
                    else
                        GlobalVars.OBJECT.getConjugatedVerb(i-1).setStack( GlobalVars.OBJECT.getConjugatedVerb(i-1).getStack() + " xxconjugatedverb_behind# " + GlobalVars.OBJECT.getComma(i).getStack()+' '+ GlobalVars.OBJECT.getConjugatableVerbalOBJECT(i+1).getVerb() ) ;
                    GlobalVars.OBJECT.remove(i+1);
                    GlobalVars.OBJECT.remove(i);
                    
                    i--;
                    // Çünkü i-1 ConjugatedVerb biz daha geriye i-2 ye bakmalýyýz.
                }
    ...
    */
    private void putAdjectivePronouns() {
            ...
            if (  GlobalVars.OBJECT.get(i-1) instanceof Pronoun && GlobalVars.OBJECT.getPronoun(i-1).isAdjectivePronoun() ) { // direkt Noun dedik çünkü daha önceki "clarifyVerbsAndNouns()" yordaminda bu fiiller Noun a çevrildi.
                ...
                if( GlobalVars.OBJECT.get(i) instanceof Noun ) {
                    ...
                    if ( GlobalVars.OBJECT.getPronoun(i-1).isPossessivePronoun() ) {
                        ...
                        // her oldu mu bir de isNoun() metodunu þart koþuyoruz.
                        // Çünkü i saw her very much gibi durumlarda .. adverblein karýþmasýný engellemek istiyoruz.
                        else if ( whichPronoun.equals("his") || ( whichPronoun.equals("her") && GlobalVars.OBJECT.getNoun(i).isNoun() ) || whichPronoun.equals("its") ) {
                        ...
                        else // özellikle her very much durumu için kullanýþlý.
                            continue;
        ...
        System.out.println();
                for(int n=0;n<GlobalVars.OBJECT.size();n++)
            System.out.println(" --> "+GlobalVars.OBJECT.get(n).getClass().getName());
        //System.out.println(GlobalVars.OBJECT.getOBJECT(6).getStack());
    ...
    */
    private void connectNounsSeparatedByCommas() {
        System.out.println("connectNounsSeparatedByCommas()");
        for ( int i = GlobalVars.OBJECT.size()-2 ; i >= 1 ; i-- ) {
    ...
    */
    ...
    /**
     * Query özellikli ConjugatedVerb lerin önünde QueryPronoun lar varsa
     * ConjugatedVerb ün query özelliðini ortadan kaldýrýyor.
     * @return void
     */
    private void queryPronounsBeforeConjugatedVerbs() {

        for ( int i = GlobalVars.OBJECT.size()-3 ; i >= 0 ; i-- ) {
            
            if ( GlobalVars.OBJECT.get(i) instanceof Pronoun && GlobalVars.OBJECT.getPronoun(i).isQueryPronoun()  && GlobalVars.OBJECT.get(i+2) instanceof ConjugatedVerb && GlobalVars.OBJECT.getConjugatedVerb(i+2).isQueryVerb() ) {
                GlobalVars.OBJECT.getConjugatedVerb(i+2).isntQueryVerb();
                GlobalVars.OBJECT.getConjugatedVerb(i+2).appendAdverb(GlobalVars.OBJECT.getPronoun(i).getStack());
                GlobalVars.OBJECT.remove(i);
            } 
            
            else if ( GlobalVars.OBJECT.get(i) instanceof ConjugatedVerb && GlobalVars.OBJECT.getConjugatedVerb(i).isQueryVerb() && GlobalVars.OBJECT.get(i+1) instanceof Preposition && GlobalVars.OBJECT.getPreposition(i+1).equals("^^yoluyla") )
                GlobalVars.OBJECT.getPreposition(i+1).setStack("taraf\u0131ndan");
        }
    ...
    /**
     * DatabasePrivateWords veritabanýna özel kelimeler oluyor.
     * Bu metod bu kelimeleri temizliyor.
     */
    private void clearDatabasePrivateWords() {
        
        for(int i=GlobalVars.OBJECT.size()-1;i>=0;i--) {     
          
          // veritabanýndan gelen ^^ ile baþlayan kelimeler temizlenmiþ oldu.
          if( GlobalVars.OBJECT.getOBJECT(i).getStack().indexOf("^^")!=-1 )
               GlobalVars.OBJECT.getOBJECT(i).setStack(GlobalVars.OBJECT.getOBJECT(i).getStack().replaceAll("\\^\\^",""));
        }
    ...
    */
    ...
    public void finalize() {
        System.out.println(GlobalVars.OBJECT.getOBJECT(0).getStack()+ "    meosss");
        int start = 0 ;
        ...
        GlobalVars.TRANSLATED[phraseNo] = phrase.toString().trim().replaceAll("xx[a-z_]+#","");
    }
